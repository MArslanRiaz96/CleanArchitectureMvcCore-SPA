...
using CleanArchitectureApi.Domain.Settings;
using CleanArchitectureApi.Infrastructure.Identity.Helpers;
using CleanArchitectureApi.Infrastructure.Identity.Models;
...
namespace CleanArchitectureApi.Infrastructure.Identity.Services
{
